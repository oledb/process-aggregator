import { Context, TYPE_DOES_NOT_EXIST_ERROR, TYPE_EXISTS_ERROR } from './context';
    ...
    describe('Context', () => {
      ...
      describe('singletons', () => {
        ...
        it('getService throw error when type not found', () => {
          ...
          expect(() => context.getService(MyService)).toThrow(TYPE_DOES_NOT_EXIST_ERROR);
        });
        ...
        it('setSingleton throw error when add same type twice', () => {
          ...
          expect(() => context.setSingleton(MyService)).toThrow(TYPE_EXISTS_ERROR);
        });
      });
      ...
      describe('type token', () => {
        ...
        it('setService throw error when add same type twice', () => {
          ...
          expect(() => context.setInstance(MyService)).toThrow(TYPE_EXISTS_ERROR);
        });
      });
