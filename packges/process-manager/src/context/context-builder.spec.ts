import { addInstance, addSingleton, createContextBuilder } from './context-builder';
  ...
  describe('task-manager', () => {
    describe('ContextBuilder', () => {
      ...
      it('create context with singleton', () => {
        const context = createContextBuilder().pipe(addSingleton(MyService)).build();
      ...
      it('create context with string instance type token', () => {
        const context = createContextBuilder().pipe(addInstance(MyService)).build();
