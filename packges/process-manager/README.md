...
* [x] Некорректный импорт action, лучше переделать на модули
...
* [x] Сделать новый слой валидации CRUD
  * [x] Слой обновления данных
  * [x] Слой чтения данных
  * [x] Добавить слой валидации и обновления данных в todo-sandbox
* [ ] Добавить реализацию класса app и фреймворка, который будет работать с ним
* [x] Переделать импорт action на модули
* [ ] Разобраться со Step и Status
  * [ ] Привести все имена к единому стандарту
  * [ ] 

# Core example

* [ ] Разобраться в nestjs
