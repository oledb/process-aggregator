import {
  addActionContext, addActions, addInitialAction, addRelations, addSingleton, addSteps,
...
export function bootstrapApp() {
  const context = createContextBuilder()
    ...
    .pipe(addActionContext(), addInitialAction(InitialTodoAction), addActions<TodoStatus, unknown, TodoCommand>(
